...
| 7 | Update | `MSIN0097_Individual.ipynb`, `docs/workflow_evidence.md`, `appendix/agent_usage_log.md`, `appendix/decision_register.md` | Added Step 3 feature engineering (`is_new_customer`, `avg_charge_per_tenure`, `service_count`) and inserted dataset preview (`X_train.head()`) after feature creation |
